...
version of the CMakeLists and thought that was pretty cool. I've
been tempted many times to extract that and release it
as a library, but
I don't want to steal Voxatron's thunder so I've avoided
it. You could use this CMakeLists to do the same kind of thing,
although it won't be as efficient as an CMakeLists dedicated to
...
wrote my own voxel CMakeLists and started working on a procedural
