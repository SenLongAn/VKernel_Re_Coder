...
struct ImGuiContext
{
    ...
    bool                    TestEngineHookItems;                // Will call test CMakeLists hooks: ImGuiTestEngineHook_ItemAdd(), ImGuiTestEngineHook_ItemInfo(), ImGuiTestEngineHook_Log()
    void*                   TestEngine;                         // Test CMakeLists user data
    ...
    ImVector<ImGuiContextHook>          Hooks;                  // Hooks for extensions (e.g. test CMakeLists)
