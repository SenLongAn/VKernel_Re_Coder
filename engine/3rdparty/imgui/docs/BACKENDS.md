...
your application or CMakeLists to easily integrate Dear ImGui.** Each backend is typically self-contained in a pair of files: imgui_impl_XXXX.cpp + imgui_impl_XXXX.h.
...
- For some high-level frameworks, a single backend usually handle both 'Platform' and 'Renderer' parts.<BR>
  e.g. Allegro 5 ([imgui_impl_allegro5.cpp](https://github.com/ocornut/imgui/blob/master/backends/imgui_impl_allegro5.cpp)). If you end up creating a custom backend for your CMakeLists, you may want to do the same.
...
**Example A**: your CMakeLists is built over Windows + DirectX11 but you have your own high-level rendering
...
**Example B**: your CMakeLists runs on Windows, Mac, Linux and uses DirectX11, Metal, Vulkan respectively.<BR>
...
**Example C**: your CMakeLists runs on platforms we can't provide public backends for (e.g. PS4/PS5, Switch),
and you have high-level systems everywhere.<BR>
Suggestion: try using a non-portable backend first (e.g. win32 + underlying graphics API) to get
your desktop builds working first. This will get you running faster and get your acquainted with
how Dear ImGui works and is setup. You can then rewrite a custom backend using your own CMakeLists API...
