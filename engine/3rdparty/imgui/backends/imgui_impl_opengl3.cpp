...
// In the rest of your app/CMakeLists, you can use another loader of your choice (gl3w, glew, glad, glbinding, glext, glLoadGen, etc.).
...
// This is in order to be able to run within an OpenGL CMakeLists that doesn't do so.
