...
layout(input_attachment_index = 0, set = 0, binding = 0) uniform highp subpassInput in_color; ///< scene

layout(set = 0, binding = 1) uniform sampler2D color_grading_lut_texture_sampler; ///< lut

layout(location = 0) out highp vec4 out_color;

void main()
{
    highp ivec2 lut_tex_size = textureSize(color_grading_lut_texture_sampler, 0); ///< size
