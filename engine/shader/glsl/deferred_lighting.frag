...
void main()
{
    ...
    highp vec3  objectColor = gbuffer.baseColor;
    ...
    if (SHADINGMODELID_UNLIT == gbuffer.shadingModelID) ///< skybox
    {
        ...
        result_color = textureLod(skybox_sampler, origin_sample_UVW, 0.0).rgb; ///< sampler
    }
