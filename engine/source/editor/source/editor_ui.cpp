...
namespace ReCoder
{
    ...
    void EditorUI::setUIColorStyle()
    {
        ...
        colors[ImGuiCol_ScrollbarBg] = ImVec4(0.03f, 0.03f, 0.04f, 0.53f);
        colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.31f, 0.31f, 0.31f, 1.00f);
        colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.41f, 0.41f, 0.41f, 1.00f);
        colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.51f, 0.51f, 0.51f, 1.00f);

        colors[ImGuiCol_CheckMark] = ImVec4(0.5f, 0.5f, 0.5f, 1.0f);
        ...
        colors[ImGuiCol_TabUnfocused] = ImVec4(5.0f / 255.0f, 7.0f / 255.0f, 26.0f / 255.0f, 25.0f / 255.0f);
        colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.05f, 0.05f, 0.05f, 1.0f);

        colors[ImGuiCol_DockingPreview] = ImVec4(0.03f, 0.03f, 0.1f, 1.0f);
