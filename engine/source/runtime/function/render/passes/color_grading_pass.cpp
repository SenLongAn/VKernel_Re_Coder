...
namespace VKernel
{
    ...
    void ColorGradingPass::setupPipelines()
    {
        ...
        VkShaderModule frag_shader_module = m_vulkan_api->createShaderModule(COLOR_GRADING_FRAG);
    ...
    void ColorGradingPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
        ...
        color_grading_LUT_image_info.sampler = m_vulkan_api->getOrCreateDefaultSampler(Default_Sampler_Linear);
