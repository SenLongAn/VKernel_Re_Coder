...
namespace VKernel
{
    ...
    {
        RenderPass::initialize(nullptr); ///< basic construction

        const CombineUIPassInitInfo* _init_info =
            static_cast<const CombineUIPassInitInfo*>(init_info); ///< Parameter Processing
    ...
    void CombineUIPass::setupDescriptorSetLayout()
    {
        ...
        global_layout_scene_input_attachment_binding.descriptorType =
        ...
        global_layout_normal_input_attachment_binding.descriptorType =
            VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT; ///< input attachment
    ...
    void CombineUIPass::setupPipelines()
    {
        ...
        // Shader Module
        VkShaderModule vert_shader_module = m_vulkan_api->createShaderModule(POST_PROCESS_VERT);
        VkShaderModule frag_shader_module = m_vulkan_api->createShaderModule(COMBINE_UI_FRAG);
    ...
    void CombineUIPass::setupDescriptorSet()
    {
        ...
        post_process_global_descriptor_set_alloc_info.descriptorPool = m_vulkan_api->getDescriptorPool();
    ...
    {
        // bind image view and descriptor
        ...
        per_frame_ui_input_attachment_info.sampler   = m_vulkan_api->getOrCreateDefaultSampler(Default_Sampler_Nearest);
